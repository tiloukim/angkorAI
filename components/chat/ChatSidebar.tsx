...
export default function ChatSidebar({
  ...
  if (!open) {
    return (
      <button
        onClick={onToggle}
        className="fixed left-2 top-4 z-50 w-8 h-8 flex items-center justify-center rounded-lg bg-sidebar hover:bg-sidebar-hover text-gray-400 hover:text-white transition-colors"
      >
  ...
  return (
    ...
    <div className="fixed left-0 top-0 h-full z-40 w-72 md:w-64 md:static md:z-auto bg-sidebar flex flex-col flex-shrink-0">
      {/* Header */}
      <div className="flex items-center justify-between px-3 pt-3 pb-2">
        <div className="flex items-center gap-2 px-1">
          <Image src="/logo.png" alt="AngkorAI" width={24} height={24} className="rounded-full" />
          <span className="font-semibold text-sm text-white">AngkorAI</span>
        </div>
        <button
          onClick={onToggle}
      ...
      <div className="px-3 mb-2">
        <button
          onClick={onNewChat}
          className="w-full flex items-center gap-2 px-3 py-2.5 rounded-xl hover:bg-sidebar-hover text-gray-300 hover:text-white text-sm transition-colors group"
        >
          ...
          <div
            ...
            className={`group flex items-center gap-2 px-3 py-2.5 rounded-xl cursor-pointer transition-colors ${
              activeConvId === conv.id
                ...
                : 'text-gray-300 hover:bg-sidebar-hover/60 hover:text-white'
            }`}
          >
            ...
            <button
              ...
              className={`flex-shrink-0 p-1 rounded opacity-0 group-hover:opacity-100 hover:bg-red-500/20 hover:text-red-400 transition-all ${
      ...
      <div className="px-3 py-3 border-t border-white/10 space-y-3">
        ...
        {dailyLimit !== Infinity && remaining !== null && (
          <div>
            ...
            <div className="h-1 bg-sidebar-hover rounded-full overflow-hidden">
              <div
        ...
        <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-sidebar-hover">
          <div className="w-7 h-7 rounded-full bg-accent/20 flex items-center justify-center text-accent flex-shrink-0">
            {planIcon}
          </div>
